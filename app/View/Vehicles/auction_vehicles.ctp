...
<section class="mid-section">
    <div class="container">
        <h1 class="main-title"><?php echo __("My Auktion"); ?> <span><?php echo __("Cars"); ?></span></h1>
					...
					if (isset($auction_data) && !empty($auction_data)) {
						...
						foreach ($auction_data as $data) {
							...
							?>">
								...
								<td class="footable-visible footable-last-column actions"><a href="<?php echo BASE_URL. '/Vehicles/vehicledetails/' . base64_encode($data['Vehicle']['id']) .'/'.base64_encode('auction_vehicles'); ?>" class="btn-Preis"><i class="fa fa-eye"></i></a></td>
							</tr>
							<?php
							$count++;
						}
