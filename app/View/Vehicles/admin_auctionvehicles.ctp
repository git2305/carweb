            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        <h4 class="m-t-0 header-title"><b><?php echo __('Auction Vehicles');?></b></h4>
							...
							<div class="row">
								...
								<div class="col-sm-6 text-xs-center text-right">
										...
										<div class="form-group">
												...
												<button class="btn btn-primary waves-effect waves-light searchauctionVehicle" type="button">Go</button>
										</div>
								</div>
							</div>
						</div>
								...
								if (isset($auction_data) && !empty($auction_data)) {
									...
									foreach ($auction_data as $data) {
										...
										?>">
											...
											<td class="footable-visible footable-last-column"><a href="<?php echo BASE_URL. '/admin/Vehicles/vehicledetailpage/' . base64_encode($data['Vehicle']['id']) .'/'.base64_encode('auction_vehicles'); ?>" class="btn-Preis"><?php echo __('Visit Details Page'); ?></a></td>
										</tr>
										<?php
										$count++;
									}
