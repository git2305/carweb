            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        <h4 class="m-t-0 header-title"><b><?php echo __('Sold Vehicles');?></b></h4>
							...
							<div class="row">
								...
								<div class="col-sm-6 text-xs-center text-right">
										...
										<div class="form-group">
												...
												<button class="btn btn-primary waves-effect waves-light searchsoldVehicle" type="button">Go</button>
										</div>
								</div>
							</div>
						</div>
                        <table id="demo-foo-filtering" class="table table-striped toggle-circle m-b-0 default footable-loaded footable vehicleTableData" data-paging="true" data-page-size="7">
							<thead>
								<tr>
									...
									<th data-hide="phone, tablet" class="footable-visible footable-last-column footable-sortable"><?php echo __('Mark As Paid');?><!--<span class="footable-sort-indicator"></span>--></th>
								...
								if (isset($auction_data) && !empty($auction_data)) {
									...
									foreach ($auction_data['SoldVehicles'] as $data) {
										...
										?>">
											...
											<td class="footable-visible">
												<?php if (isset($data['Vehicle']['is_paid']) && !empty($data['Vehicle']['is_paid']) && $data['Vehicle']['is_paid'] == '1') { ?>
												<a href="javascript:void(0);" class="paidinv" style="background:green;padding:3px 12px;color:#fff;" disabled>Paid</a>
												<?php } else { ?>
												<a href="javascript:void(0);" class="unpaidinv" style="background:red;padding:3px 12px;color:#fff;" data-id = "<?php echo $data['Vehicle']['id']; ?>">Unpaid</a>
												<?php } ?>
											</td>
