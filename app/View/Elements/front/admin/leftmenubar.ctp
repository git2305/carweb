    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="<?= BASE_URL . '/admin/Users/dashboard' ?>" class="waves-effect waves-light active"><i class="md md-home"></i> <span> Dashboard </span> </a>
                </li>

                <li class="text-muted menu-title">Extra</li>

                <li class="has_sub">
                    <a href="#" class="waves-effect waves-light"><i class="md md-account-box"></i><span> User Management </span></a>
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect waves-light"><i class="md md-polymer"></i> <span> <?php echo __('Vehicles Management'); ?></span> </a>
                    <ul class="list-unstyled">
                        <li><a href="#"><?php echo __('Add New Car');?></a></li>
                        <li><?= $this->Html->link('Manage Vehicles', array('controller' => 'Vehicles', 'action' => 'listing')); ?></li>
                        <li><?= $this->Html->link('Manage Category', array('controller' => 'Vehicles', 'action' => 'vehicleCategory')); ?></li>

                    </ul>
                </li>
                
                <li class="has_sub">
                    <a href="#" class="waves-effect waves-light"><i class="md md-menu"></i> <span> Company Management </span> </a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect waves-light"><i class="md md-pages"></i><span>CMS Pages</span></a>
                    <ul class="list-unstyled">
