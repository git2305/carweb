 ...
 */
	Configure::write('Security.salt', 'DYhG10b0qyJfIxfs2guVoUubWwvnhfT50FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309631453542496749684785');
...
/*adeed by Sumit 19-12-2013*/
Configure::write('Globals',array());

define('BASE_URL','http://'.$_SERVER['HTTP_HOST'].'/carlisting');
define('SITE_URL','http://'.$_SERVER['HTTP_HOST'].'/carlisting');
define('SITE_URL_ADMIN','http://'.$_SERVER['HTTP_HOST'].'/carlisting/admin');